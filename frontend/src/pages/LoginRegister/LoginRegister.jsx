          ...
          <div className="flex-container">
            ...
            <div className="login">
              ...
              <form action="#" className="login-form" id="login">
                ...
                <div className="form-item">
                  <p>
                    <label htmlFor="loginPassword"> گذرواژه * </label>
                  </p>
                  <Input
                    type="password"
                ...
                <Button
                  ...
                  className={` submit-btn ${
                    loginFormState.isFormValid && isGoogleRecaptchVerify
                      ? "button-bg-success"
                      : "button-bg-error"
                  }`}
                  disabled={
            ...
            <div className="register">
              ...
              <form action="#" className="register-form" id="enroll">
                <div className="form-item">
                  <p>
                    <label htmlFor="enrollName"> نام *</label>
                  </p>
                  <Input
                    type="text"
                    inputId="enrollName"
                ...
                <div className="form-item">
                  <p>
                    <label htmlFor="enrollUsername"> نام کاربری *</label>
                  </p>
                  <Input
                    type="text"
                ...
                <div className="form-item">
                  <p>
                    <label htmlFor="enrollphone"> شماره موبایل *</label>
                  </p>
                  <Input
                    type="text"
                    inputId="enrollphone"
                ...
                <div className="form-item">
                  <p>
                    <label htmlFor="enrollEmail"> آدرس ایمیل *</label>
                  </p>
                  <Input
                    type="email"
                    inputId="enrollEmail"
                ...
                <div className="form-item">
                  <p>
                    <label htmlFor="enrollPassword"> گذرواژه * </label>
                  </p>
                  <Input
                    type="password"
                ...
                <div className="form-item">
                  <p>
                    <label htmlFor="ConfirmEnrollPassword">
                      {" "}
                      تایید گذرواژه*{" "}
                    </label>
                  </p>
